...
namespace ec_cpp {
    ...
    constexpr size_t kMaxValidators = ec_cpp::PolyEncoder_f2e16::Descriptor::kFieldSize;
    ...
    Result<ReedSolomon<ec_cpp::PolyEncoder_f2e16>> create(size_t n_validators) {
        ...
        return ReedSolomon<ec_cpp::PolyEncoder_f2e16>::create(n_wanted, resultGetValue(std::move(k_wanted_result)),
